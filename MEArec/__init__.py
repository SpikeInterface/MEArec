from MEArec.tools import load_templates, load_recordings, save_recording_generator, save_template_generator, \
    ...
    get_default_cell_models_folder, convert_recording_to_new_version, available_probes, save_dict_to_hdf5, \
    save_recording_to_file, load_recordings_from_file, load_dict_from_hdf5, get_default_drift_dict, plot_cell_drifts,\
